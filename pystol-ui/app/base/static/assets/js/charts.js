...
var radarChart = new Chart(document.getElementById('node-01'), {
  type: 'radar',
  data: {
    labels: ['CPU', 'Memory', 'IOPS', 'Filesystem'],
    datasets: [{
      label: 'System status',
...
var radarChart = new Chart(document.getElementById('node-02'), {
  type: 'radar',
  data: {
    labels: ['CPU', 'Memory', 'IOPS', 'Filesystem'],
    datasets: [{
...
var radarChart = new Chart(document.getElementById('node-03'), {
  type: 'radar',
  data: {
    labels: ['CPU', 'Memory', 'IOPS', 'Filesystem'],
    datasets: [{
...
var radarChart = new Chart(document.getElementById('node-04'), {
  type: 'radar',
  data: {
    labels: ['CPU', 'Memory', 'IOPS', 'Filesystem'],
    datasets: [{
...
var radarChart = new Chart(document.getElementById('node-05'), {
  type: 'radar',
  data: {
    labels: ['CPU', 'Memory', 'IOPS', 'Filesystem'],
    datasets: [{
